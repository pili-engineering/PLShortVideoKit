...
@class PLSGPUImageMovie;
/*! Protocol for getting Movie played callback.
 */
@protocol PLSGPUImageMovieDelegate <NSObject>

- (void)didCompletePlayingMovie;

- (CVPixelBufferRef)GPUImageMovie:(PLSGPUImageMovie *)GPUImageMovie didOutputPixelBuffer:(CVPixelBufferRef)pixelBuffer timestamp:(CMTime)timestamp;
@end

/*! Source object for filtering movies
 */
@interface PLSGPUImageMovie : PLSGPUImageOutput
 ...
 */
@property (readwrite, nonatomic, assign) id <PLSGPUImageMovieDelegate>delegate;
