...
/*!
 @method shortVideoRecorder:cameraSourceDidGetSampleBuffer:
 @abstract 获取摄像头原始数据
 ...
 @since 3.2.1
 */
- (void)shortVideoRecorder:(PLShortVideoRecorder *__nonnull)recorder cameraSourceDidGetSampleBuffer:(CMSampleBufferRef __nonnull)sampleBuffer;
...
/*!
 @method initWithVideoConfiguration:audioConfiguration:videoCaptureEnabled:audioCaptureEnabled:
 @abstract 初始化方法

 @param videoConfiguration 视频采集和编码参数
 @param audioConfiguration 音频采集和编码参数
 @param videoCaptureEnabled 是否启用视频采集
 @param audioCaptureEnabled 是否启用音频采集
