...
inline void TargetTracker::loadTarget(Target * arg0, FunctorOfVoidFromPointerOfTargetAndBool arg1)
{
    if (cdata_ == NULL) {
        return;
    }
    easyar_TargetTracker_loadTarget(cdata_, (arg0 == NULL ? NULL : arg0->get_cdata()), FunctorOfVoidFromPointerOfTargetAndBool_to_c(arg1));
}
inline void TargetTracker::unloadTarget(Target * arg0, FunctorOfVoidFromPointerOfTargetAndBool arg1)
{
    if (cdata_ == NULL) {
        return;
    }
    easyar_TargetTracker_unloadTarget(cdata_, (arg0 == NULL ? NULL : arg0->get_cdata()), FunctorOfVoidFromPointerOfTargetAndBool_to_c(arg1));
}
