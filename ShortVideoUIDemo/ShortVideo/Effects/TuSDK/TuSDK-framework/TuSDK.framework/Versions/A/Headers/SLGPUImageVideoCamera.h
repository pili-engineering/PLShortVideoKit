...
#import "SLGPUImageColorConversion.h"

//Optionally override the YUV to RGB matrices
void LSQSetColorConversion601( GLfloat conversionMatrix[9] );
void LSQSetColorConversion601FullRange( GLfloat conversionMatrix[9] );
void LSQSetColorConversion709( GLfloat conversionMatrix[9] );


//Delegate Protocal for Face Detection.
@protocol LSQGPUImageVideoCameraDelegate <NSObject>
...
/**
 A SLGPUImageOutput that provides frames from either camera
*/
@interface SLGPUImageVideoCamera : SLGPUImageOutput <AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureAudioDataOutputSampleBufferDelegate>
{
    ...
    BOOL capturePaused;
    LSQGPUImageRotationMode outputRotation, internalRotation;
    dispatch_semaphore_t frameRenderingSemaphore;
        
    BOOL captureAsYUV;
    GLuint luminanceTexture, chrominanceTexture;

    __unsafe_unretained id<LSQGPUImageVideoCameraDelegate> _delegate;
}
...
@property(nonatomic, assign) id<LSQGPUImageVideoCameraDelegate> delegate;
