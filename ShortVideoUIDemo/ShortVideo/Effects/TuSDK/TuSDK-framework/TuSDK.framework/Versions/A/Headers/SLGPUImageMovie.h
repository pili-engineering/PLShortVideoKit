 ...
 */
@protocol LSQGPUImageMovieDelegate <NSObject>
 ...
 */
@interface SLGPUImageMovie : SLGPUImageOutput
...
- (void)enableSynchronizedEncodingUsingMovieWriter:(SLGPUImageMovieWriter *)movieWriter;
