...
@interface SLGPUImagePicture : SLGPUImageOutput
{
...
- (void)processImageUpToFilter:(SLGPUImageOutput<SLGPUImageInput> *)finalFilterInChain withCompletionHandler:(void (^)(UIImage *processedImage))block;
