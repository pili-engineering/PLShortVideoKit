...
extern NSString *const LSQKGPUImageColorSwizzlingFragmentShaderString;

@protocol LSQGPUImageMovieWriterDelegate <NSObject>
...
@interface SLGPUImageMovieWriter : NSObject <SLGPUImageInput>
{
...
@property(nonatomic, assign) id<LSQGPUImageMovieWriterDelegate> delegate;
...
@property(nonatomic, retain) SLGPUImageContext *movieWriterContext;
