...
- (void)layoutSubviews {
    ...
    _filterListView.frame = CGRectMake(CGRectGetMinX(safeBounds), 0, CGRectGetWidth(safeBounds), kFilterListHeight);
    ...
    CGRectMake(CGRectGetMinX(safeBounds) + paramtersViewLeftMargin,
               paramtersViewAvailableHeight - _paramtersView.contentHeight,
